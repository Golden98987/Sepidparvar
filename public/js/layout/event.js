...
$(document).on("click",".sortbycategory",function(){
    var id = $(this).attr('data-id');
        ...
        success:function(data)
        {
                ...
                {
                    console.log("category/"+ data['category'][i]+"/"+data['result'][i].name +"/"+ data['result'][i].id);

                    str+="<div class="+'"col-xl-3 col-lg-4 col-sm-6"'+" >"
                    +"<div class="+'"product"'+">"
                        +"<span class="+'"pr_flash bg_green"'+">فروش</span>"
                        +"<div class="+'"product_img"'+">"
                            +"<a href="+'"#"'+"><img style="+ '"height:150px"'+" src="+data['path'][i]+" alt="+'"product_img1"'+"></a> "   
                        ...
                        +"<div class="+'"product_info"'+">"
                            +"<h6><a href="+'"'+"category/"+ data['category'][i]+"/"+data['result'][i].name +"/"+ data['result'][i].id+'"'+">"+data['result'][i].name+" </a></h6>"
                            +"<div class="+'"rating"'+">"
                                +"<div class="+'"product_rate"'+" style="+'"width:80%"'+"></div>"
                            +"</div>"
                            +"<span class="+'"price"'+">"+data['result'][i].price+"تومان </span>"
                        +"</div>"
...
$(document).on('change','#SelectState',function()
{
	...
	with(document.getElementById('city')) 
	{
		...
		if(state == "تهران")
		{
			options[0] = new Option	(	'لطفا شهر را انتخاب نمایید' 	,	'لطفا شهر را انتخاب نمایید' 	);
			...
			            options[75] = new Option	(	'نسيم شهر','نسيم شهر'	);
			...
			            options[17] = new Option	(	'بوانات','بوانات');
			            options[18] = new Option	(	'بيرم' 	,	'بيرم' 	);
			            options[19] = new Option	(	'جنت شهر','جنت شهر'	);
			...
			            options[27] = new Option	(	"ريوش","ريوش"	);
			...
			            options[26] = new Option	(	'کشاورز','کشاورز'	);
			...
			            options[38] = new Option	(	'نگار' 	,	'نگار' 	);
